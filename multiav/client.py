            ...
            try:
                ...
                while not report_finished:
                    ...
                    try:
                        ...
                        report_finished = "end_date" in report and report["end_date"] is not None
                        ...
                        if not report_finished:
                            # wait some seconds before re-querying
                        ...
                        print("[MultiAVClient] Report id {1} query exception. "
                              "Retrying in 5s... Exception: {0}".
                              format(e, report_id))
                        print(e)
                        time.sleep(5)
